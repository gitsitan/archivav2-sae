...
import { getStructureById, updateStructure, getStructuresForSelection } from "../../actions";
...
const UpdateStructurePage = () => {
  ...
  useEffect(() => {
    const fetchStructureData = async () => {
      ...
      try {
        // Charger les structures pour la sélection
        const structuresResult = await getStructuresForSelection();
        if (structuresResult.success && structuresResult.data) {
                ...
                <form onSubmit={handleSubmit} className="px-6 py-8 space-y-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      {structures
                        .filter(structure => structure.isActive && structure.id !== Number(id))
                        .map((structure) => (
