                ...
                {(serieLevel > 1 ? activeTab === "details" : true) && (
                  <form onSubmit={handleSubmit} className="px-6 py-8 space-y-6">
                    ...
                    <div>
                      ...
                      >
                        <option value="">
                          Aucune série parente (série racine)
                        </option>
                      ...
                      {selectedParentId && (
                        <p className="text-sm text-blue-600 mt-1">
                          Le niveau sera calculé automatiquement selon la série
                          parente
                        </p>
                      )}
                    </div>
                    ...
                    <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-4">
                      <p className="text-sm text-amber-800 dark:text-amber-200">
                        <strong>Note :</strong>
                        <br />• <strong>DCL</strong> = Durée de Conservation
                        Légale (durée minimale de conservation)
                        <br />• <strong>DUA</strong> = Durée d'Utilité
                        Administrative (durée d'utilité pour l'administration)
                      </p>
                    </div>
