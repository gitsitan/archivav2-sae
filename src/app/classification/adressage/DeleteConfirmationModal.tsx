        ...
        <div className="relative w-full max-w-md transform rounded-lg bg-white dark:bg-gray-800 shadow-xl transition-all">
          ...
          <div className="px-6 py-4">
            <div className="text-sm text-gray-600 dark:text-gray-400">
              <p className="mb-4">
                Êtes-vous sûr de vouloir supprimer la localisation{" "}
              ...
              <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-3">
                <p className="text-sm text-yellow-800 dark:text-yellow-200">
                  ...
                  Si cette localisation contient des sous-localisations ou des dossiers, vous devrez d'abord les supprimer.
                </p>
              </div>
            </div>
          </div>
